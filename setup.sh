...
wget https://raw.githubusercontent.com/jubairbro/AUTO-SCRIPT/master/ssh/cf && chmod +x cf && ./cf
...
#Install SlowDNS
echo -e "\e[33m-----------------------------------\033[0m"
echo -e "$BGreen          Install NT SlowDNS            $NC"
echo -e "\e[33m-----------------------------------\033[0m"
sleep 0.5
clear
wget https://raw.githubusercontent.com/jubairbro/AUTO-SCRIPT/master/slowdns/slowdns.sh && chmod +x slowdns.sh && ./slowdns.sh
clear
#Install HTTP Custom
echo -e "\e[33m-----------------------------------\033[0m"
echo -e "$BGreen          Install NT HTTP Custom          $NC"
echo -e "\e[33m-----------------------------------\033[0m"
sleep 0.5
clear
wget https://raw.githubusercontent.com/jubairbro/AUTO-SCRIPT/master/httpcustom/httpcustom.sh && chmod +x httpcustom.sh && ./httpcustom.sh
clear
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/jubairbro/AUTO-SCRIPT/master/menu/versi  )
...
rm /root/httpcustom.sh >/dev/null 2>&1
